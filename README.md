...
`aws-bedrock-cost-tool` is a Python CLI tool built with modern tooling and best practices.
...
```
aws-bedrock-cost-tool/
├── aws_bedrock_cost_tool/    # Main package
│   ├── __init__.py
...
# Run with coverage
uv run pytest tests/ --cov=aws_bedrock_cost_tool
```
